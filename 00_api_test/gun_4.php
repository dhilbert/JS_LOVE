<?php
	...
	$url ="http://apis.data.go.kr/1613000/BldRgstService_v2/getBrAtchJibunInfo?sigunguCd=11680&bjdongCd=10300&numOfRows=1000000&ServiceKey=".$serviceKey;
	$response = file_get_contents($url);
	$object = simplexml_load_string($response);
	$data_arr = $object->body[0]->items[0]; 
	$sql = "INSERT INTO api_test_gun_4 (
						platPlc,
						sigunguCd,
						bjdongCd,
						platGbCd,
