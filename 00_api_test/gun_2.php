<?php
	...
	$url ="http://apis.data.go.kr/1613000/BldRgstService_v2/getBrTitleInfo?sigunguCd=11260&bjdongCd=10600&numOfRows=1000&ServiceKey=".$serviceKey;
	...
	$sql = "INSERT INTO api_test_gun_2 (
			platPlc,
			sigunguCd,
			bjdongCd,
			platGbCd,
